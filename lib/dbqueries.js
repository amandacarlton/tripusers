...
module.exports = {
  ...
  populateDashboardInfo: function (userId) {
    return this.userdashboard(userId).then(function (dashboard) {
      return this.getTrips(dashboard);
    }.bind(this));
  },

  populateTripInfo: function (tripId) {
    return this.tripshow(tripId).then(function (tripInfo) {
      return this.getEmails(tripInfo);
    }.bind(this));
  },
  ...
  getEmails: function (tripInfo) {
    if(tripInfo.comments.length){
      ...
      return Promise.all(promiseUser).then(function () {
        return tripInfo;
      });
    } else {
      return tripInfo;
